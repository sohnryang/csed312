...
/* Systemwide load average of MLFQS Scheduler. */
fp_t mlfqs_global_load_avg;
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  t->mlfqs_nice = MLFQS_NICE_DEFAULT;
  t->mlfqs_recent_cpu = MLFQS_LOAD_AVG_DEFAULT;
